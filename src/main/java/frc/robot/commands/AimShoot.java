...
public class AimShoot extends Command {
    ...
    private final double subWooferDistance = 1.26; //(1.33 real field) 1.38 at practice field 1.21 at 930, 1.25 at comp, 1.31 at marquette //1.33 at Archimedes (blue) 1.26 (red) // 1.38 at blue practice field
    private final double subWooferAngle = 115.5; //115
    private final double subWooferSpeed = 35.0; //50
    
    private final double xSpotDistance = 2.37; //2.57 at blue practice field 2.45 at marquette //2.45 at Archimedes (blue) 2.37 (red)
    private final double xSpotAngle = 131.0; //132
    private final double xSpotSpeed = 45.0;

    private final double podiumDistance = 3.09; //3.17 at comp, 3.02 at marquette, 3.08 Archimedes (blue) 3.09 (red)
